...
async fetchData() {
    let response = await httpServices.get("/radio");
  ...
  render() {
    ...
    return (
      <section className="caro caro_sqr caro_circ mWrap">
       <div className="head">
            <div className="row row2">
                <div className="col">
                <h1 class="_h2">Radio</h1>
                </div>
                <a class="" title="Radio See all" href="/songs"><span>See All</span></a>
            </div>
        </div>
        ...
        <ul className="card_wrap">
          {dealPage.map(item => (
            <li className="card" key={item.id}>
              <a className="img default_bg" aria-label="artwork" href={item.link}>
              ...
              <div className="t_wrap">
                <a alt={item.title} title={item.title} className="al t_over" href={item.link}>
                  {item.title}
                </a>
              </div>
            </li>
